...
class Example(Frame):
    ...
    def initUI(self):
        ...
        self.parent.title("Chat Translation")
        self.pack(fill=BOTH, expand=True)

        self.grid_columnconfigure(4, weight=1)
        self.grid_rowconfigure(3, weight=1)

        # Change these to output language?
    ...
    def onStart(self):
        ...
        self.p1 = Process(target=ocr.startOcr, args=(q,))#, digits, accuracy))
        self.p1.start()
